...
파일: `stay-ops-front/src/shared/ui/theme-toggle.tsx`

역할: **5가지 테마(light / dark / sepia / ocean / forest)** 중 하나를 사용자가 선택할 수 있는 **팝오버(드롭다운) UI**.
...
containerRef.current 가 돔 정보를 가지고 있음
    <div ref={containerRef} className="relative">
